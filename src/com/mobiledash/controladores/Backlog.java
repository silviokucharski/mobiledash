...
public class Backlog extends Activity{
	...
	private void rellenaDatos(){
		...
		tareas3.add(new Tarea(1,"Alta artículos","Crear el alta de artículos",10,0,""));
		tareas3.add(new Tarea(2,"Modificar artículos","Crear modificaciones de artículos",8,0,""));
		tareas3.add(new Tarea(3,"Eliminar artículos","Crear eliminado de artículos",12,0,""));
        datos.add(new Historia(1,"ABM artículos","","",tareas3));
